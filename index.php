...
<body id="body">	
	<script src="jscript.js" type="text/javascript"></script>
		...
		<div id="homePageD1">
				...
				<p id="homePageTxt">Welkom op de website van De Schepijswinkel&#8482;<br>De bestemming voor al het schepijs waar u van kan dromen!</p>
				<p id="homePageImg1"><img src="plaatjes/homeD1.jpg" id="sideImg"></p>
		...
		<div id="homeText">
			<h2 id="homeHeader">
			Welkom op de website van De Schepijswinkel&#8482;<br>
			De bestemming voor al het schepijs waar u van kan dromen!
			</h2>
				<p>
